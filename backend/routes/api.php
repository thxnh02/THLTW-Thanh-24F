...
use App\Http\Controllers\Api\V1\AccountReturnController;
...
use App\Http\Controllers\Api\V1\Admin\ReturnRequestController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', EnsureAccountActive::class])->group(function (): void {
        ...
        Route::get('account/orders/{code}/invoice.pdf', [AccountOrderController::class, 'invoicePdf']);
        ...
        Route::get('account/returns', [AccountReturnController::class, 'index']);
        Route::post('account/returns', [AccountReturnController::class, 'store']);
        Route::get('account/returns/{code}', [AccountReturnController::class, 'show']);
    ...
    Route::prefix('admin')->middleware(['auth:sanctum', EnsureAccountActive::class, EnsureAdmin::class])->group(function (): void {
        ...
        Route::patch('returns/{returnRequest}/status', [ReturnRequestController::class, 'updateStatus']);
